...
function PrimaryLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="group inline-flex min-h-12 items-center justify-center gap-3 rounded-full bg-dogify-blue px-6 py-3 text-sm font-bold text-white shadow-premium transition hover:-translate-y-0.5 hover:bg-slate-950"
    >
      {children}
...
function SecondaryLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="inline-flex min-h-12 items-center justify-center gap-3 rounded-full border border-slate-200 bg-white/70 px-6 py-3 text-sm font-bold text-dogify-ink shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:border-dogify-cyan hover:text-dogify-blue"
    >
      {children}
    ...
    <nav className="fixed left-0 right-0 top-0 z-50 px-4 py-4">
      <div className="glass mx-auto flex min-h-16 max-w-6xl items-center justify-between gap-3 rounded-full px-4 md:px-5">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/contact"
            className="hidden h-11 items-center justify-center rounded-full bg-dogify-green px-5 text-sm font-black text-white shadow-lg shadow-green-500/20 transition hover:-translate-y-0.5 sm:inline-flex"
          >
            Get Started
          </Link>
          <button
            ...
            {[
              ...
              return (
                <div
                  ...
                  className={`floating-card glass absolute ${index % 2 ? "float-delay" : "float-slow"} ${item.className} flex items-center gap-3 rounded-3xl px-4 py-3 max-sm:px-3 max-sm:py-2`}
                >
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <Link href={service.href} className="mt-5 inline-flex items-center gap-2 text-sm font-black text-dogify-blue">
    ...
    <section className="section-shell py-24">
      <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-dogify-blue via-dogify-cyan to-dogify-green p-8 text-white shadow-premium md:p-14">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <Link
            href="/contact"
            className="inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-white px-7 py-4 text-sm font-black text-dogify-blue shadow-xl transition hover:-translate-y-0.5"
          >
  ...
  return (
    <section className="section-shell grid min-h-[720px] items-center gap-10 pb-16 pt-32 lg:grid-cols-[0.92fr_1.08fr]">
      <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ duration: 0.75 }}>
        <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-white/70 bg-white/60 px-4 py-2 text-sm font-bold text-dogify-blue shadow-sm backdrop-blur">
          <Icon className="h-4 w-4 text-dogify-green" />
          {eyebrow}
        </div>
...
export function ServicePage({ slug }: { slug: ServiceSlug }) {
  ...
  return (
    <SiteFrame>
      ...
      <section className="section-shell py-20">
        <div className="grid gap-8 rounded-[2.5rem] bg-white p-6 shadow-premium lg:grid-cols-[0.85fr_1.15fr] lg:p-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {service.collections.map((item) => (
              <Link key={item.title} href="/contact" className="group rounded-3xl border border-slate-100 bg-slate-50 p-5 transition hover:-translate-y-1 hover:bg-white hover:shadow-lg">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">{item.copy}</p>
                <span className="mt-4 inline-flex items-center gap-2 text-sm font-black text-dogify-blue">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {service.process.map((step) => (
            <div key={step.step} className="glass rounded-[2rem] p-7">
              <p className="text-sm font-black text-dogify-cyan">{step.step}</p>
    ...
    <SiteFrame>
      ...
      <section className="section-shell grid gap-8 py-20 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <form className="glass rounded-[2.5rem] p-6 md:p-8">
          ...
          <button type="button" className="mt-6 inline-flex min-h-12 items-center justify-center gap-3 rounded-full bg-dogify-blue px-6 py-3 text-sm font-bold text-white shadow-premium transition hover:-translate-y-0.5">
    ...
    <SiteFrame>
      ...
      <section className="section-shell py-20">
        <div className="glass rounded-[2.5rem] p-6 md:p-10">
          <p className="text-sm font-bold uppercase tracking-[0.24em] text-dogify-cyan">Last updated: June 18, 2026</p>
