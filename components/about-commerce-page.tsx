      ...
      <section className="section-shell grid min-h-[680px] items-center gap-10 pb-16 pt-32 lg:grid-cols-[0.92fr_1.08fr]">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-xl leading-9 text-slate-600">
            DOGIFY brings food, accessories, medicines, and health support into one dependable platform for modern pet parents.
          </p>
        </div>
        ...
        <div className="relative min-h-[460px] overflow-hidden rounded-[3rem] shadow-premium">
          ...
          <div className="glass-dark absolute bottom-5 left-5 right-5 rounded-[2rem] p-6 text-white">
            <p className="text-sm font-bold uppercase tracking-[0.24em] text-dogify-green">
              Mission
            </p>

            <p className="mt-3 text-3xl font-black">
              Create India&apos;s most trusted pet-care ecosystem.
            </p>
          </div>
        </div>
      </section>
        ...
        {[
          {
            ...
            copy: "Every interaction should make care easier to understand.",
            icon: ShieldCheck
          },
          {
            title: "Premium but warm",
            copy: "DOGIFY feels polished, friendly, and useful every day.",
            icon: HeartHandshake
          },
          {
            title: "Connected care",
            copy: "Products, services, support, and guidance work around the same pet parent journey.",
            icon: Sparkles
          }
        ].map((value) => {
          ...
          return (
            <article key={value.title} className="glass rounded-[2rem] p-7">
              ...
              <h2 className="mt-6 text-2xl font-black text-dogify-ink">
                {value.title}
              </h2>
